...
st.caption("必ずしもスコアが毎晩100になるまで睡眠をとることではありません。 1晩あたり7〜9時間（米国睡眠医学会が推奨する平均）一貫して眠っていて、ご自身のいつもの総睡眠時間から大きく外れていない場合は、十分な睡眠がとれています。 このため、Ouraの健康に関する観点から、85程度のスコアが判断基準と見なされています。70未満は注意が必要です。")
